export const featureShowcase = [
  ...
  },
  {
    ...
    title: 'Adjust perspective dynamically',
    description:
      'Smoothly transition from orthographic to wide-angle to telephoto views. Frame your scene perfectly while maintaining focus on your geometry.',
    poster: 'images/posters/feature-default.png',
    sources: [
      { src: 'videos/perspective.mp4', type: 'video/mp4' },
    ],
  },
  {
